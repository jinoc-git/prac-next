...
const Pay = (props: Props) => {
  ...
  return (
    <div
      className="flex items-center mx-auto font-semibold text-gray_dark_1 
      sm:w-[286px] sm:h-[27px] sm:text-sm sm:mt-[11px]
      md:w-[680px] md:text-[16px] md:mb-[15px] "
    >
      <div className="flex items-center sm:h-[27px] sm:w-[286px] md:w-full md:justify-normal sm:justify-between">
        ...
        <div className="relative flex flex-col mt-[10px]">
          <input
            ...
            className="text-[14px] font-medium border rounded-lg pl-[10px] pr-[16px] outline-none w-[150px] h-[30px] border-gray read-only:pl-0 read-only:cursor-default read-only:border-none read-only:text-normal read-only:font-semibold"
          />
