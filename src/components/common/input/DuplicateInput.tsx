  ...
  return (
    <div className="relative w-full rounded">
      ...
      <button
        ...
        className="absolute top-[4px] right-[4px] w-[68px] h-[34px] p-1 text-sm border text-[#6E6F76] bg-white  hover:font-semibold disabled:bg-gray_light_3 disabled:text-white rounded normal-transition"
      >
        중복확인
      </button>
